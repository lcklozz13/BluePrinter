...
@interface LoginLockView ()<KKGestureLockViewDelegate>
...
{
    UIWindow *screenWindow = [UIApplication sharedApplication].windows.firstObject;
    _lockView = [[KKGestureLockView alloc] initWithFrame:screenWindow.bounds];
...
- (void)gestureLockView:(KKGestureLockView *)gestureLockView didEndWithPasscode:(NSString *)passcode
{
    ...
    if (delegate && [delegate respondsToSelector:@selector(gestureLockViewDidEndWithPasscode:)])
    {
        [delegate gestureLockViewDidEndWithPasscode:passcode];
    }
}
@end
