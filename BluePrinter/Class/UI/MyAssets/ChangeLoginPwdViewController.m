...
@property (weak, nonatomic) UITextField     *nPwdTextField;
@property (weak, nonatomic) UITextField     *confirmNewPwdTextField;
@end
...
- (nullable UIView *)tableView:(UITableView *)tableView viewForFooterInSection:(NSInteger)section
{
    ...
    [footView.saveBtn setTitle:@"下一步" forState:UIControlStateNormal];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.row == 0)
    {
        ...
        [cell.inputTextField setPlaceholder:@"请输入登录密码"];
        cell.inputTextField.delegate = self;
        self.pwdTextField = cell.inputTextField;
    }
    else if (indexPath.row == 1)
    {
        ...
        cell.inputTextField.delegate = self;
        self.nPwdTextField = cell.inputTextField;
    }
    else if (indexPath.row == 2)
    {
        ...
        cell.inputTextField.delegate = self;
        self.confirmNewPwdTextField = cell.inputTextField;
    }
...
{
    self.continueBtn.enabled = (self.pwdTextField.text.length > 0 && self.nPwdTextField.text.length > 0  && self.confirmNewPwdTextField.text.length > 0);
}
